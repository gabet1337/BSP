...
//        st.put(new Interval1D(10, 20,1), "Interval 1");
//        
//        
//        
//        for (Interval1D x : st.searchAll(new Interval1D(5.0,10.01,1)))
//        	System.out.println(x + " ");
//        
//        st.remove(new Interval1D(0.0,100.00,1));
//        
//        System.out.println("WE GOT:");
//        
//        for (Interval1D x : st.searchAll(new Interval1D(0.0,1000.00,2)))
//        	System.out.println(x + " ");
